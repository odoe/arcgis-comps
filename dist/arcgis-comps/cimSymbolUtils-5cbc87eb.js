import { C } from './cimAnalyzer-39e96fe6.js';
import { E } from './Utils-8509bfb9.js';
import { M } from './MaterialKey-7a78d364.js';
import { a as a$1, t } from './devEnvironmentUtils-930ae782.js';
import { C as s$1, av as h, a0 as U } from './jsxFactory-ef3e403e.js';
import { D as B, E as c$1 } from './unitUtils-8a2b838a.js';
import { m, j, b, c, p as p$1 } from './styleUtils-f18fb225.js';

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
const a={marker:E.MARKER,fill:E.FILL,line:E.LINE,text:E.TEXT};class r$1{constructor(e,r,i,l){const n={minScale:null==r?void 0:r.minScale,maxScale:null==r?void 0:r.maxScale},c=s(n);this.layers=e,this.data=r,this.hash=this._createHash()+c,this.rendererKey=i;for(const s of e){const e=a[s.type];s.materialKey=M(e,this.rendererKey),s.maxVVSize=l,s.scaleInfo=n,s.templateHash+=c;}}get type(){return "expanded-cim"}_createHash(){let e="";for(const t of this.layers)e+=t.templateHash;return e}}function s(e){return e.minScale||e.maxScale?e.minScale+"-"+e.maxScale:""}
