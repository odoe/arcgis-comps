import { I as S, aQ as l$1, aR as z, aS as g, f as s$1, e, a as d, i as i$1 } from './jsxFactory-ef3e403e.js';
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
function p(e){return e&&"object"==typeof e&&"refreshTimestamp"in e&&"refresh"in e}const n=p=>{let n=class extends p{constructor(...e){super(...e),this.refreshInterval=0,this.refreshTimestamp=0,this._debounceHasDataChanged=z((()=>this.hasDataChanged())),this.when().then((()=>{o(this);}),(()=>{}));}destroy(){s(this);}get refreshParameters(){return {_ts:this.refreshTimestamp||null}}refresh(e=Date.now()){g(this._debounceHasDataChanged()).then((r=>{r&&this._set("refreshTimestamp",e),this.emit("refresh",{dataChanged:r});}),(e=>{s$1.getLogger(this.declaredClass).error(e),this.emit("refresh",{dataChanged:!1,error:e});}));}async hasDataChanged(){return !0}};return e([d({type:Number,cast:e=>e>=.1?e:e<=0?0:.1,json:{write:!0}})],n.prototype,"refreshInterval",void 0),e([d({readOnly:!0})],n.prototype,"refreshTimestamp",void 0),e([d()],n.prototype,"refreshParameters",null),n=e([i$1("esri.layers.mixins.RefreshableLayer")],n),n};
