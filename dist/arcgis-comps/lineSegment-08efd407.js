import { dg as u$2, cf as t$5, aA as n$1, bC as r$3, bn as c$2, bh as z, aC as e$1, ba as d$1, bl as u$3, dd as p$1, dh as x$1 } from './unitUtils-8a2b838a.js';
import { cI as r$2 } from './jsxFactory-ef3e403e.js';
...
*/
function n(){return [0,0,0,0]}function t$1(n){return [n[0],n[1],n[2],n[3]]}function r$1(n,t,r,e){return [n,t,r,e]}function e(t){const r=n(),e=Math.min(4,t.length);for(let n=0;n<e;++n)r[n]=t[n];return r}function u(n,t){return new Float64Array(n,t,4)}function a$2(){return n()}function o$1(){return r$1(1,1,1,1)}function s$1(){return r$1(1,0,0,0)}function c$1(){return r$1(0,1,0,0)}function i$1(){return r$1(0,0,1,0)}function f$1(){return r$1(0,0,0,1)}const _=a$2(),l$1=o$1(),N=s$1(),U=c$1(),I=i$1(),O=f$1(),T=Object.freeze({__proto__:null,create:n,clone:t$1,fromValues:r$1,fromArray:e,createView:u,zeros:a$2,ones:o$1,unitX:s$1,unitY:c$1,unitZ:i$1,unitW:f$1,ZEROS:_,ONES:l$1,UNIT_X:N,UNIT_Y:U,UNIT_Z:I,UNIT_W:O});

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
class s{constructor(t){this.allocator=t,this._items=[],this._itemsPtr=0,this.grow();}get(){return 0===this._itemsPtr&&r$2((()=>this.reset())),this._itemsPtr===this._items.length&&this.grow(),this._items[this._itemsPtr++]}reset(){const t=Math.min(3*Math.max(8,this._itemsPtr),this._itemsPtr+3*i);this._items.length=Math.min(t,this._items.length),this._itemsPtr=0;}grow(){for(let t=0;t<Math.max(8,Math.min(this._items.length,i));t++)this._items.push(this.allocator());}}const i=1024;
...
export { A, r$1 as a, b, c, f, m, n, r, s, v };
