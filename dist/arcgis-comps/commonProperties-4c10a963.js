import { y as y$1, s as s$1 } from './TimeExtent-ecf7e6f2.js';
import { o as o$2, r as r$2, M, k } from './Portal-f1457cb4.js';
import { p as p$2 } from './persistableUrlUtils-a9da326c.js';
import { t, c as e$1, F as T, r as r$1, e as e$2, b as d$2, i as i$1, ac as s$2, a3 as o$1 } from './cast-e5ea2533.js';
import { a as a$1 } from './JSONSupport-8dda8bae.js';
import { f as b$1, j as r$3 } from './opacityUtils-5755cb64.js';
import { m as m$3 } from './lengthUtils-2084b777.js';

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
function m$2(t){return "feature"===(null==t?void 0:t.type)}function s(t){return "map-image"===(null==t?void 0:t.type)}function f$1(t){return void 0!==t.timeInfo}async function u$1(n,r){if(0===n.length)return y$1.allTime;const u=n.filter(f$1);await Promise.all(u.map((t=>t.load({signal:r}))));const a=[],l=[];for(const t of u)(m$2(t)||s(t))&&t.timeInfo.hasLiveData?a.push(t):l.push(t);const c=t$1=>t(t$1)||t$1.isAllTime,p=l.map((t=>t.timeInfo.fullTimeExtent));if(p.some(c))return y$1.allTime;const T$1=a.map((async t=>{const{timeExtent:n}=await t.fetchRecomputedExtents({signal:r});return n||e$1(t.timeInfo.fullTimeExtent)})),d=(await T(T$1)).map((t=>t.value));if(d.some(c))return y$1.allTime;return d.concat(p).reduce(((t,e)=>t.union(e)))}function a(e){if(!e)return e;const{start:i,end:o}=e;return new y$1({start:r$1(i)?s$1(i,-i.getTimezoneOffset(),"minutes"):i,end:r$1(o)?s$1(o,-o.getTimezoneOffset(),"minutes"):o})}function l$2(e){if(!e)return e;const{start:i,end:o}=e;return new y$1({start:r$1(i)?s$1(i,i.getTimezoneOffset(),"minutes"):i,end:r$1(o)?s$1(o,o.getTimezoneOffset(),"minutes"):o})}
