import { f as s$1, h as s$2, A as r } from './jsxFactory-a3b6abde.js';
import { aJ as u, bH as c } from './Graphic-08cda9ca.js';
import { Z, v, n } from './spatialQuerySupport-476f549c.js';
import { b } from './Query-a20a7572.js';
import { u as u$1 } from './FeatureStore2D-848550a5.js';
...
import './CircularArray-811183bd.js';
...
*/
const t=s$1.getLogger("esri.views.2d.layers.features.support.whereUtils"),a={getAttribute:(e,r)=>e.field(r)};async function s(r,s){const n=await import('./WhereClause-f0afbbff.js');try{const o=n.WhereClause.create(r,s);if(!o.isStandardized){const r=new s$2("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",o);t.error(r);}return e=>{const r=e.readArcadeFeature();return o.testFeature(r,a)}}catch(o){return t.warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",r),e=>!0}}
