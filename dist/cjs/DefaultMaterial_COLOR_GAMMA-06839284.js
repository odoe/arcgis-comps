...
const types = require('./types-122ed12c.js');
...
const quat = require('./quat-38386b3c.js');
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
class n$1{constructor(r){this.streamDataRequester=r;}async loadJSON(r,e){return this.load("json",r,e)}async loadBinary(r,e){return request.G$1(r)?(request.h(e),request.H$5(r)):this.load("binary",r,e)}async loadImage(r,e){return this.load("image",r,e)}async load(t,i,m){if(request.t(this.streamDataRequester))return (await request.E(i,{responseType:c$2[t]})).data;const n=await request.a$15(this.streamDataRequester.request(i,t,m));if(!0===n.ok)return n.value;throw request.b$9(n.error),new request.s$1("",`Request for resource failed: ${n.error}`)}}const c$2={image:"image",binary:"array-buffer",json:"json"};
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
function M(t,n,r){return request.c$2(O,n,t),request.c$2(V,r,t),request.s$9(request._$1(O,O,V))/2}new lineSegment.s(lineSegment.v);new lineSegment.s((()=>({p0:null,p1:null,p2:null})));const O=request.n(),V=request.n();

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
let s=(()=>{const t=new Uint32Array(131072);for(let n=0;n<t.length;++n)t[n]=n;return t})();const f=new Uint16Array([0]),c=(()=>{const t=new Uint16Array(65536);for(let n=0;n<t.length;++n)t[n]=n;return t})();function l(t){if(1===t)return f;if(t<c.length)return new Uint16Array(c.buffer,0,t);if(t>s.length){const n=Math.max(2*s.length,t);s=new Uint32Array(n);for(let t=0;t<s.length;t++)s[t]=t;}return new Uint32Array(s.buffer,0,t)}function a(t){if(1===t)return new Uint16Array(f);if(t<c.length)return new Uint16Array(c.slice(0,t));if(t>s.length){const n=new Uint32Array(t);for(let t=0;t<n.length;t++)n[t]=t;return n}return new Uint32Array(s.slice(0,t))}function u(e,o,s){if(!e)return !1;const{size:f,data:c}=e;request.o$8(s,0,0,0),request.o$8(U,0,0,0);let l=0,a=0;for(let u=0;u<o.length-2;u+=3){const e=o[u+0]*f,h=o[u+1]*f,g=o[u+2]*f;request.o$8(y,c[e+0],c[e+1],c[e+2]),request.o$8(w,c[h+0],c[h+1],c[h+2]),request.o$8(A,c[g+0],c[g+1],c[g+2]);const m=M(y,w,A);m?(request.u$1(y,y,w),request.u$1(y,y,A),request.d$2(y,y,1/3*m),request.u$1(s,s,y),l+=m):(request.u$1(U,U,y),request.u$1(U,U,w),request.u$1(U,U,A),a+=3);}return (0!==a||0!==l)&&(0!==l?(request.d$2(s,s,1/l),!0):0!==a&&(request.d$2(s,U,1/a),!0))}function h(n,e,o){if(!n||!e)return !1;const{size:i,data:s}=n;request.o$8(o,0,0,0);let f=-1,c=0;for(let t=0;t<e.length;t++){const n=e[t]*i;f!==n&&(o[0]+=s[n+0],o[1]+=s[n+1],o[2]+=s[n+2],c++),f=n;}return c>1&&request.d$2(o,o,1/c),c>0}const y=request.n(),w=request.n(),A=request.n(),U=request.n();

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
function n(n,o=l){return "number"==typeof n?o(n):request.i$11(n)||request.e$32(n)?new Uint32Array(n):n}function o$1(t){const e="number"==typeof t?t:t.length;if(e<3)return new Uint16Array(0);const r=e-2,n=r<=65536?new Uint16Array(3*r):new Uint32Array(3*r);if("number"==typeof t){let t=0;for(let e=0;e<r;e+=1)e%2==0?(n[t++]=e,n[t++]=e+1,n[t++]=e+2):(n[t++]=e+1,n[t++]=e,n[t++]=e+2);}else {let e=0;for(let o=0;o<r;o+=1)if(o%2==0){const r=t[o],i=t[o+1],f=t[o+2];n[e++]=r,n[e++]=i,n[e++]=f;}else {const r=t[o+1],i=t[o],f=t[o+2];n[e++]=r,n[e++]=i,n[e++]=f;}}return n}function i(t){const e="number"==typeof t?t:t.length;if(e<3)return new Uint16Array(0);const r=e-2,n=r<=65536?new Uint16Array(3*r):new Uint32Array(3*r);if("number"==typeof t){let t=0;for(let e=0;e<r;++e)n[t++]=0,n[t++]=e+1,n[t++]=e+2;return n}{const e=t[0];let o=t[1],i=0;for(let f=0;f<r;++f){const r=t[f+2];n[i++]=e,n[i++]=o,n[i++]=r,o=r;}return n}}
