...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
class i$6 extends t$3{constructor(t,s,i,e,h,a){super(t),this._lazyPt=[],this._hasZ=!1,this._hasM=!1,this._spRef=s,this._hasZ=i,this._hasM=e,this._cacheId=h,this._partId=a;}get(t){if(void 0===this._lazyPt[t]){const i=this._elements[t];if(void 0===i)return;const e=this._hasZ,h=this._hasM;let a=null;a=e&&!h?new unitUtils.b(i[0],i[1],i[2],void 0,this._spRef):h&&!e?new unitUtils.b(i[0],i[1],void 0,i[2],this._spRef):e&&h?new unitUtils.b(i[0],i[1],i[2],i[3],this._spRef):new unitUtils.b(i[0],i[1],this._spRef),a.cache._arcadeCacheId=this._cacheId.toString()+"-"+this._partId.toString()+"-"+t.toString(),this._lazyPt[t]=a;}return this._lazyPt[t]}equalityTest(t){return t===this||null!==t&&(t instanceof i$6!=!1&&t.getUniqueHash()===this.getUniqueHash())}getUniqueHash(){return this._cacheId.toString()+"-"+this._partId.toString()}}
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
function e$6(t,n,e){return Math.sqrt((t[0]-n[0])**2+(t[1]-n[1])**2+(void 0!==t[2]&&void 0!==n[2]?(t[2]*e-n[2]*e)**2:0))}const r$6=[];for(const v of [[9002,56146130,6131,6132,8050,8051,8228],[9003,5702,6358,6359,6360,8052,8053],[9095,5754]]){const t=v[0];for(let n=1;n<v.length;n++)r$6[v[n]]=t;}const o$4=[];function s$6(t){return t.vcsWkid&&void 0!==r$6[t.vcsWkid]?o$4[r$6[t.vcsWkid]]:t.latestVcsWkid&&void 0!==r$6[t.latestVcsWkid]?o$4[r$6[t.latestVcsWkid]]:1}function c$3(t,n,e){const r={x:0,y:0};n&&(r.z=0),e&&(r.m=0);let o=0,s=t[0];for(let c=0;c<t.length;c++){const a=t[c];if(!1===f$3(a,s)){const t=h$5(s,a,n),c=i$4(s,a,n,e);c.x*=t,c.y*=t,r.x+=c.x,r.y+=c.y,n&&(c.z*=t,r.z+=c.z),e&&(c.m*=t,r.m+=c.m),o+=t,s=a;}}return o>0?(r.x/=o,r.y/=o,n&&(r.z/=o),e&&(r.m/=o)):(r.x=t[0][0],r.y=t[0][1],n&&(r.z=t[0][2]),e&&n?r.m=t[0][3]:e&&(r.m=t[0][2])),r}function i$4(t,n,e,r){const o={x:(t[0]+n[0])/2,y:(t[1]+n[1])/2};return e&&(o.z=(t[2]+n[2])/2),e&&r?o.m=(t[3]+n[3])/2:r&&(o.m=(t[2]+n[2])/2),o}function a$3(t,n){if(t.length<=1)return 0;let e=0;for(let r=1;r<t.length;r++)e+=h$5(t[r-1],t[r],n);return e}function h$5(t,n,e){const r=n[0]-t[0],o=n[1]-t[1];if(e){const t=n[2]-n[2];return Math.sqrt(r*r+o*o+t*t)}return Math.sqrt(r*r+o*o)}function f$3(t,n){if(t.length!==n.length)return !1;for(let e=0;e<t.length;e++)if(t[e]!==n[e])return !1;return !0}function l$4(n){const e={x:0,y:0,spatialReference:n.spatialReference.toJSON()},r={x:0,y:0,spatialReference:n.spatialReference.toJSON()};let o=0,s=0;for(let t=0;t<n.paths.length;t++){if(0===n.paths[t].length)continue;const i=a$3(n.paths[t],!0===n.hasZ);if(0===i){const r=c$3(n.paths[t],!0===n.hasZ,!0===n.hasM);e.x+=r.x,e.y+=r.y,!0===n.hasZ&&(e.z+=r.z),!0===n.hasM&&(e.m+=r.m),++o;}else {const e=c$3(n.paths[t],!0===n.hasZ,!0===n.hasM);r.x+=e.x*i,r.y+=e.y*i,!0===n.hasZ&&(r.z+=e.z*i),!0===n.hasM&&(r.m+=e.m*i),s+=i;}}return s>0?(r.x/=s,r.y/=s,!0===n.hasZ&&(r.z/=s),!0===n.hasM&&(r.m/=s),new unitUtils.b(r)):o>0?(e.x/=o,e.y/=o,!0===n.hasZ&&(r.z/=o),!0===n.hasM&&(e.m/=o),new unitUtils.b(e)):null}function u$3(n){if(0===n.points.length)return null;let e=0,r=0,o=0,s=0;for(let t=0;t<n.points.length;t++){const c=n.getPoint(t);!0===c.hasZ&&(o+=c.z),!0===c.hasM&&(s+=c.m),e+=c.x,r+=c.y,s+=c.m;}const c={x:e/n.points.length,y:r/n.points.length,spatialReference:null};return c.spatialReference=n.spatialReference.toJSON(),!0===n.hasZ&&(c.z=o/n.points.length),!0===n.hasM&&(c.m=s/n.points.length),new unitUtils.b(c)}function y$3(t,n){return t.x*n.x+t.y*n.y}function x$4(t,n){return t.x*n.y-n.x*t.y}function m$1(t,n,e=0){for(;t<e;)t+=n;const r=e+n;for(;t>=r;)t-=n;return t}function g$4(t,n){return Math.atan2(n.y-t.y,n.x-t.x)}function p$2(t,n){return m$1(g$4(t,n),2*Math.PI)*(180/Math.PI)}function M$5(t,n){return m$1(Math.PI/2-g$4(t,n),2*Math.PI)*(180/Math.PI)}function z$4(t,n,e){const r={x:t.x-n.x,y:t.y-n.y},o={x:e.x-n.x,y:e.y-n.y};return Math.atan2(x$4(r,o),y$3(r,o))}function P$6(t,n,e){return m$1(z$4(t,n,e),2*Math.PI)*(180/Math.PI)}function d$3(t,n,e){return m$1(-1*z$4(t,n,e),2*Math.PI)*(180/Math.PI)}o$4[9002]=.3048,o$4[9003]=.3048006096012192,o$4[9095]=.3048007491;const I$4=[0,0];function Z$3(t){for(let e=0;e<t.length;e++){const r=t[e];for(let s=0;s<r.length-1;s++){const o=r[s],c=r[s+1];for(let r=e+1;r<t.length;r++)for(let e=0;e<t[r].length-1;e++){const s=t[r][e],i=t[r][e+1];if(unitUtils.z(o,c,s,i,I$4)&&!(I$4[0]===o[0]&&I$4[1]===o[1]||I$4[0]===s[0]&&I$4[1]===s[1]||I$4[0]===c[0]&&I$4[1]===c[1]||I$4[0]===i[0]&&I$4[1]===i[1]))return !0}}const o=r.length;if(!(o<3))for(let t=0;t<=o-2;t++){const e=r[t],s=r[t+1];for(let c=t+2;c<=o-2;c++){const t=r[c],o=r[c+1];if(unitUtils.z(e,s,t,o,I$4)&&!(I$4[0]===e[0]&&I$4[1]===e[1]||I$4[0]===t[0]&&I$4[1]===t[1]||I$4[0]===s[0]&&I$4[1]===s[1]||I$4[0]===o[0]&&I$4[1]===o[1]))return !0}}}return !1}

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
function D$5(e){return e instanceof b$5||"object"==typeof e&&"FeatureSetReader"===e.type}function P$5(P,M){P.ringisclockwise=function(e,r){return M(e,r,(function(e,r,a){z$5(a,1,1);let l=[],s=!1,f=!1;if(null===a[0])return !1;if(I$7(a[0])){for(const e of a[0]){if(!(e instanceof unitUtils.b))throw new Error("Invalid Argument");l.push(e.hasZ?e.hasM?[e.x,e.y,e.z,e.m]:[e.x,e.y,e.z]:[e.x,e.y]);}l.length>0&&(s=a[0][0].hasZ,f=a[0][0].hasM);}else if(a[0]instanceof i$6)l=a[0]._elements,l.length>0&&(s=a[0]._hasZ,f=a[0]._hasM);else {if(!J$3(a[0]))throw new Error("Invalid Argument");for(const e of a[0].toArray()){if(!(e instanceof unitUtils.b))throw new Error("Invalid Argument");l.push(e.hasZ?e.hasM?[e.x,e.y,e.z,e.m]:[e.x,e.y,e.z]:[e.x,e.y]);}l.length>0&&(s=a[0].get(0).hasZ,f=a[0].get(0).hasM);}return !(l.length<3)&&unitUtils.f$1(l,f,s)}))},P.polygon=function(n,i){return M(n,i,(function(i,o,s){z$5(s,1,1);let f=null;if(s[0]instanceof h$9){if(f=ae$3(b$5.parseGeometryFromDictionary(s[0]),n.spatialReference),f instanceof unitUtils.v==!1)throw new Error("Illegal Parameter")}else f=s[0]instanceof unitUtils.v?unitUtils.d$1(s[0].toJSON()):ae$3(new unitUtils.v(JSON.parse(s[0])),n.spatialReference);if(null!==f&&!1===f.spatialReference.equals(n.spatialReference))throw new Error("Cannot create Geometry in this SpatialReference. Engine is using a different spatial reference.");return oe$2(f)}))},P.polyline=function(n,i){return M(n,i,(function(i,o,s){z$5(s,1,1);let f=null;if(s[0]instanceof h$9){if(f=ae$3(b$5.parseGeometryFromDictionary(s[0]),n.spatialReference),f instanceof unitUtils.m$4==!1)throw new Error("Illegal Parameter")}else f=s[0]instanceof unitUtils.m$4?unitUtils.d$1(s[0].toJSON()):ae$3(new unitUtils.m$4(JSON.parse(s[0])),n.spatialReference);if(null!==f&&!1===f.spatialReference.equals(n.spatialReference))throw new Error("Cannot create Geometry in this SpatialReference. Engine is using a different spatial reference.");return oe$2(f)}))},P.point=function(n,i){return M(n,i,(function(i,o,s){z$5(s,1,1);let f=null;if(s[0]instanceof h$9){if(f=ae$3(b$5.parseGeometryFromDictionary(s[0]),n.spatialReference),f instanceof unitUtils.b==!1)throw new Error("Illegal Parameter")}else f=s[0]instanceof unitUtils.b?unitUtils.d$1(s[0].toJSON()):ae$3(new unitUtils.b(JSON.parse(s[0])),n.spatialReference);if(null!==f&&!1===f.spatialReference.equals(n.spatialReference))throw new Error("Cannot create Geometry in this SpatialReference. Engine is using a different spatial reference.");return oe$2(f)}))},P.multipoint=function(n,i){return M(n,i,(function(i,o,s){z$5(s,1,1);let f=null;if(s[0]instanceof h$9){if(f=ae$3(b$5.parseGeometryFromDictionary(s[0]),n.spatialReference),f instanceof unitUtils.m$5==!1)throw new Error("Illegal Parameter")}else f=s[0]instanceof unitUtils.m$5?unitUtils.d$1(s[0].toJSON()):ae$3(new unitUtils.m$5(JSON.parse(s[0])),n.spatialReference);if(null!==f&&!1===f.spatialReference.equals(n.spatialReference))throw new Error("Cannot create Geometry in this SpatialReference. Engine is using a different spatial reference.");return oe$2(f)}))},P.extent=function(n,i){return M(n,i,(function(i,o,f){f=me$2(f),z$5(f,1,1);let c=null;if(f[0]instanceof h$9)c=ae$3(b$5.parseGeometryFromDictionary(f[0]),n.spatialReference);else if(f[0]instanceof unitUtils.b){const e={xmin:f[0].x,ymin:f[0].y,xmax:f[0].x,ymax:f[0].y,spatialReference:f[0].spatialReference.toJSON()},r=f[0];r.hasZ?(e.zmin=r.z,e.zmax=r.z):r.hasM&&(e.mmin=r.m,e.mmax=r.m),c=unitUtils.d$1(e);}else c=f[0]instanceof unitUtils.v||f[0]instanceof unitUtils.m$4||f[0]instanceof unitUtils.m$5?unitUtils.d$1(f[0].extent.toJSON()):f[0]instanceof unitUtils.M?unitUtils.d$1(f[0].toJSON()):ae$3(new unitUtils.M(JSON.parse(f[0])),n.spatialReference);if(null!==c&&!1===c.spatialReference.equals(n.spatialReference))throw new Error("Cannot create Geometry in this SpatialReference. Engine is using a different spatial reference.");return oe$2(c)}))},P.geometry=function(n,i){return M(n,i,(function(i,o,s){z$5(s,1,1);let f=null;if(f=D$5(s[0])?ae$3(s[0].geometry(),n.spatialReference):s[0]instanceof h$9?ae$3(b$5.parseGeometryFromDictionary(s[0]),n.spatialReference):ae$3(unitUtils.d$1(JSON.parse(s[0])),n.spatialReference),null!==f&&!1===f.spatialReference.equals(n.spatialReference))throw new Error("Cannot create Geometry in this SpatialReference. Engine is using a different spatial reference.");return oe$2(f)}))},P.setgeometry=function(e,r){return M(e,r,(function(e,r,n){if(z$5(n,2,2),!D$5(n[0]))throw new Error("Illegal Argument");if(!0===n[0].immutable)throw new Error("Feature is Immutable");if(!(n[1]instanceof unitUtils.p||null===n[1]))throw new Error("Illegal Argument");return n[0]._geometry=n[1],R$3}))},P.feature=function(n,t){return M(n,t,(function(t,i,o){if(0===o.length)throw new Error("Missing Parameters");let l=null;if(1===o.length)if(Z$4(o[0]))l=b$5.fromJson(JSON.parse(o[0]));else if(D$5(o[0]))l=b$5.createFromArcadeFeature(o[0]);else if(o[0]instanceof unitUtils.p)l=b$5.createFromGraphicLikeObject(o[0],null,null);else {if(!(o[0]instanceof h$9))throw new Error("Illegal Argument");{let n=o[0].hasField("geometry")?o[0].field("geometry"):null,t=o[0].hasField("attributes")?o[0].field("attributes"):null;null!==n&&n instanceof h$9&&(n=b$5.parseGeometryFromDictionary(n)),null!==t&&(t=b$5.parseAttributesFromDictionary(t)),l=b$5.createFromGraphicLikeObject(n,t,null);}}else if(2===o.length){let n=null,t=null;if(null!==o[0])if(o[0]instanceof unitUtils.p)n=o[0];else {if(!(n instanceof h$9))throw new Error("Illegal Argument");n=b$5.parseGeometryFromDictionary(o[0]);}if(null!==o[1]){if(!(o[1]instanceof h$9))throw new Error("Illegal Argument");t=b$5.parseAttributesFromDictionary(o[1]);}l=b$5.createFromGraphicLikeObject(n,t,null);}else {let n=null;const t={};if(null!==o[0])if(o[0]instanceof unitUtils.p)n=o[0];else {if(!(n instanceof h$9))throw new Error("Illegal Argument");n=b$5.parseGeometryFromDictionary(o[0]);}for(let e=1;e<o.length;e+=2){const r=$$4(o[e]),n=o[e+1];if(!(null==n||Z$4(n)||isNaN(n)||E$6(n)||Y$2(n)||v$5(n)))throw new Error("Illegal Argument");if(C$5(n)||!1===w$4(n))throw new Error("Illegal Argument");t[r]=n===R$3?null:n;}l=b$5.createFromGraphicLikeObject(n,t,null);}return l._geometry=ae$3(l.geometry(),n.spatialReference),l.immutable=!1,l}))},P.dictionary=function(r,n){return M(r,n,(function(r,n,t){if(0===t.length){const r=new h$9;return r.immutable=!1,r}if(1===t.length&&Z$4(t[0]))try{const r=JSON.parse(t[0]),n=h$9.convertObjectToArcadeDictionary(r,!1);return n.immutable=!1,n}catch(s){throw new Error("Missing Parameters or Illegal Json")}if(t.length%2!=0)throw new Error("Missing Parameters");const a={};for(let e=0;e<t.length;e+=2){const r=$$4(t[e]),n=t[e+1];if(!(null==n||Z$4(n)||isNaN(n)||E$6(n)||Y$2(n)||v$5(n)||I$7(n)||J$3(n)))throw new Error("Illegal Argument");if(C$5(n))throw new Error("Illegal Argument");a[r]=n===R$3?null:n;}const l=new h$9(a);return l.immutable=!1,l}))},P.haskey=function(r,n){return M(r,n,(function(r,n,i){z$5(i,2,2);const o=$$4(i[1]);if(D$5(i[0]))return i[0].hasField(o);if(i[0]instanceof h$9)return i[0].hasField(o);throw new Error("Illegal Argument")}))},P.indexof=function(e,r){return M(e,r,(function(e,r,n){z$5(n,2,2);const a=n[1];if(I$7(n[0])){for(let e=0;e<n[0].length;e++)if(W$2(a,n[0][e]))return e;return -1}if(J$3(n[0])){const e=n[0].length();for(let r=0;r<e;r++)if(W$2(a,n[0].get(r)))return r;return -1}throw new Error("Illegal Argument")}))},P.angle=function(e,r){return M(e,r,(function(e,r,n){if(n=me$2(n),z$5(n,2,3),!(n[0]instanceof unitUtils.b))throw new Error("Illegal Argument");if(!(n[1]instanceof unitUtils.b))throw new Error("Illegal Argument");if(n.length>2&&!(n[2]instanceof unitUtils.b))throw new Error("Illegal Argument");return 2===n.length?p$2(n[0],n[1]):P$6(n[0],n[1],n[2])}))},P.bearing=function(e,r){return M(e,r,(function(e,r,n){if(n=me$2(n),z$5(n,2,3),!(n[0]instanceof unitUtils.b))throw new Error("Illegal Argument");if(!(n[1]instanceof unitUtils.b))throw new Error("Illegal Argument");if(n.length>2&&!(n[2]instanceof unitUtils.b))throw new Error("Illegal Argument");return 2===n.length?M$5(n[0],n[1]):d$3(n[0],n[1],n[2])}))},P.isselfintersecting=function(e,r){return M(e,r,(function(r,n,a){a=me$2(a),z$5(a,1,1);let l=a[0];if(l instanceof unitUtils.v)return l.isSelfIntersecting;if(l instanceof unitUtils.m$4)return l=l.paths,Z$3(l);if(l instanceof unitUtils.m$5){const e=l.points;for(let r=0;r<e.length;r++)for(let n=0;n<e.length;n++)if(n!==r){let t=!0;for(let i=0;i<e[r].length;i++)if(e[r][i]!==e[n][i]){t=!1;break}if(!0===t)return !0}}return !(!I$7(l)&&!J$3(l))&&(l=he$2(l,e.spatialReference),null!==l&&(l=l.paths),Z$3(l))}))};}

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
function r$5(e){if(void 0===e)return null;if("number"==typeof e)return e;let r=e.toLowerCase();switch(r=r.replace(/\s/g,""),r=r.replace(/-/g,""),r){case"meters":case"meter":case"m":case"squaremeters":case"squaremeter":return 109404;case"miles":case"mile":case"squaremile":case"squaremiles":return 109413;case"kilometers":case"kilometer":case"squarekilometers":case"squarekilometer":case"km":return 109414;case"acres":case"acre":case"ac":return 109402;case"hectares":case"hectare":case"ha":return 109401;case"yard":case"yd":case"yards":case"squareyards":case"squareyard":return 109442;case"feet":case"ft":case"foot":case"squarefeet":case"squarefoot":return 109405;case"nm":case"nmi":case"nauticalmile":case"nauticalmiles":case"squarenauticalmile":case"squarenauticalmiles":return 109409}return null}function s$5(r){if(null===r)return null;switch(r.type){case"polygon":case"multipoint":case"polyline":return r.extent;case"point":return new unitUtils.M({xmin:r.x,ymin:r.y,xmax:r.x,ymax:r.y,spatialReference:r.spatialReference});case"extent":return r}return null}function a$2(e){if(void 0===e)return null;if("number"==typeof e)return e;let r=e.toLowerCase();switch(r=r.replace(/\s/g,""),r=r.replace(/-/g,""),r){case"meters":case"meter":case"m":case"squaremeters":case"squaremeter":return 9001;case"miles":case"mile":case"squaremile":case"squaremiles":return 9035;case"kilometers":case"kilometer":case"squarekilometers":case"squarekilometer":case"km":return 9036;case"yard":case"yd":case"yards":case"squareyards":case"squareyard":return 9096;case"feet":case"ft":case"foot":case"squarefeet":case"squarefoot":return 9002;case"nm":case"nmi":case"nauticalmile":case"nauticalmiles":case"squarenauticalmile":case"squarenauticalmiles":return 9030}return null}function c$2(e){if(null===e)return null;const r=e.clone();return void 0!==e.cache._geVersion&&(r.cache._geVersion=e.cache._geVersion),r}

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
let M$4=null;function P$4(e){return 0===request.a.indexOf("4.")?unitUtils.v.fromExtent(e):new unitUtils.v({spatialReference:e.spatialReference,rings:[[[e.xmin,e.ymin],[e.xmin,e.ymax],[e.xmax,e.ymax],[e.xmax,e.ymin],[e.xmin,e.ymin]]]})}function Z$2(n){M$4=n;}function v$4(n,e){if("polygon"!==n.type&&"polyline"!==n.type&&"extent"!==n.type)return 0;let r=1;if(n.spatialReference.vcsWkid||n.spatialReference.latestVcsWkid){r=s$6(n.spatialReference)/unitUtils.H$1(n.spatialReference);}let t=0;if("polyline"===n.type)for(const i of n.paths)for(let n=1;n<i.length;n++)t+=e$6(i[n],i[n-1],r);else if("polygon"===n.type)for(const i of n.rings){for(let n=1;n<i.length;n++)t+=e$6(i[n],i[n-1],r);(i[0][0]!==i[i.length-1][0]||i[0][1]!==i[i.length-1][1]||void 0!==i[0][2]&&i[0][2]!==i[i.length-1][2])&&(t+=e$6(i[0],i[i.length-1],r));}else "extent"===n.type&&(t+=2*e$6([n.xmin,n.ymin,0],[n.xmax,n.ymin,0],r),t+=2*e$6([n.xmin,n.ymin,0],[n.xmin,n.ymax,0],r),t*=2,t+=4*Math.abs(O$5(n.zmax,0)*r-O$5(n.zmin,0)*r));const l=new unitUtils.m$4({hasZ:!1,hasM:!1,spatialReference:n.spatialReference,paths:[[0,0],[0,t]]});return M$4.planarLength(l,e)}function z$3(n,I){function y(n){if(z$5(n,2,2),n[0]instanceof unitUtils.p&&n[1]instanceof unitUtils.p);else if(n[0]instanceof unitUtils.p&&null===n[1]);else if(n[1]instanceof unitUtils.p&&null===n[0]);else if(null!==n[0]||null!==n[1])throw new Error("Illegal Argument")}n.disjoint=function(n,e){return I(n,e,(function(n,e,r){return y(r=me$2(r)),null===r[0]||null===r[1]||M$4.disjoint(r[0],r[1])}))},n.intersects=function(n,e){return I(n,e,(function(n,e,r){return y(r=me$2(r)),null!==r[0]&&null!==r[1]&&M$4.intersects(r[0],r[1])}))},n.touches=function(n,e){return I(n,e,(function(n,e,r){return y(r=me$2(r)),null!==r[0]&&null!==r[1]&&M$4.touches(r[0],r[1])}))},n.crosses=function(n,e){return I(n,e,(function(n,e,r){return y(r=me$2(r)),null!==r[0]&&null!==r[1]&&M$4.crosses(r[0],r[1])}))},n.within=function(n,e){return I(n,e,(function(n,e,r){return y(r=me$2(r)),null!==r[0]&&null!==r[1]&&M$4.within(r[0],r[1])}))},n.contains=function(n,e){return I(n,e,(function(n,e,r){return y(r=me$2(r)),null!==r[0]&&null!==r[1]&&M$4.contains(r[0],r[1])}))},n.overlaps=function(n,e){return I(n,e,(function(n,e,r){return y(r=me$2(r)),null!==r[0]&&null!==r[1]&&M$4.overlaps(r[0],r[1])}))},n.equals=function(n,e){return I(n,e,(function(n,e,r){return z$5(r,2,2),r[0]===r[1]||(r[0]instanceof unitUtils.p&&r[1]instanceof unitUtils.p?M$4.equals(r[0],r[1]):!(!E$6(r[0])||!E$6(r[1]))&&r[0].getTime()===r[1].getTime())}))},n.relate=function(n,e){return I(n,e,(function(n,e,r){if(r=me$2(r),z$5(r,3,3),r[0]instanceof unitUtils.p&&r[1]instanceof unitUtils.p)return M$4.relate(r[0],r[1],$$4(r[2]));if(r[0]instanceof unitUtils.p&&null===r[1])return !1;if(r[1]instanceof unitUtils.p&&null===r[0])return !1;if(null===r[0]&&null===r[1])return !1;throw new Error("Illegal Argument")}))},n.intersection=function(n,e){return I(n,e,(function(n,e,r){return y(r=me$2(r)),null===r[0]||null===r[1]?null:M$4.intersect(r[0],r[1])}))},n.union=function(n,r){return I(n,r,(function(r,t,i){const o=[];if(0===(i=me$2(i)).length)throw new Error("Function called with wrong number of Parameters");if(1===i.length)if(I$7(i[0])){const n=me$2(i[0]);for(let e=0;e<n.length;e++)if(null!==n[e]){if(!(n[e]instanceof unitUtils.p))throw new Error("Illegal Argument");o.push(n[e]);}}else {if(!J$3(i[0])){if(i[0]instanceof unitUtils.p)return ae$3(c$2(i[0]),n.spatialReference);if(null===i[0])return null;throw new Error("Illegal Argument")}{const n=me$2(i[0].toArray());for(let e=0;e<n.length;e++)if(null!==n[e]){if(!(n[e]instanceof unitUtils.p))throw new Error("Illegal Argument");o.push(n[e]);}}}else for(let n=0;n<i.length;n++)if(null!==i[n]){if(!(i[n]instanceof unitUtils.p))throw new Error("Illegal Argument");o.push(i[n]);}return 0===o.length?null:M$4.union(o)}))},n.difference=function(n,r){return I(n,r,(function(n,r,t){return y(t=me$2(t)),null!==t[0]&&null===t[1]?c$2(t[0]):null===t[0]?null:M$4.difference(t[0],t[1])}))},n.symmetricdifference=function(n,r){return I(n,r,(function(n,r,t){return y(t=me$2(t)),null===t[0]&&null===t[1]?null:null===t[0]?c$2(t[1]):null===t[1]?c$2(t[0]):M$4.symmetricDifference(t[0],t[1])}))},n.clip=function(n,e){return I(n,e,(function(n,e,r){if(r=me$2(r),z$5(r,2,2),!(r[1]instanceof unitUtils.M)&&null!==r[1])throw new Error("Illegal Argument");if(null===r[0])return null;if(!(r[0]instanceof unitUtils.p))throw new Error("Illegal Argument");return null===r[1]?null:M$4.clip(r[0],r[1])}))},n.cut=function(n,r){return I(n,r,(function(n,r,t){if(t=me$2(t),z$5(t,2,2),!(t[1]instanceof unitUtils.m$4)&&null!==t[1])throw new Error("Illegal Argument");if(null===t[0])return [];if(!(t[0]instanceof unitUtils.p))throw new Error("Illegal Argument");return null===t[1]?[c$2(t[0])]:M$4.cut(t[0],t[1])}))},n.area=function(n,e){return I(n,e,(function(e,t,o){if(z$5(o,1,2),null===(o=me$2(o))[0])return 0;if(I$7(o[0])||J$3(o[0])){const e=de$2(o[0],n.spatialReference);return null===e?0:M$4.planarArea(e,r$5(O$5(o[1],-1)))}if(!(o[0]instanceof unitUtils.p))throw new Error("Illegal Argument");return M$4.planarArea(o[0],r$5(O$5(o[1],-1)))}))},n.areageodetic=function(n,e){return I(n,e,(function(e,t,o){if(z$5(o,1,2),null===(o=me$2(o))[0])return 0;if(I$7(o[0])||J$3(o[0])){const e=de$2(o[0],n.spatialReference);return null===e?0:M$4.geodesicArea(e,r$5(O$5(o[1],-1)))}if(!(o[0]instanceof unitUtils.p))throw new Error("Illegal Argument");return M$4.geodesicArea(o[0],r$5(O$5(o[1],-1)))}))},n.length=function(n,e){return I(n,e,(function(e,r,o){if(z$5(o,1,2),null===(o=me$2(o))[0])return 0;if(I$7(o[0])||J$3(o[0])){const e=he$2(o[0],n.spatialReference);return null===e?0:M$4.planarLength(e,a$2(O$5(o[1],-1)))}if(!(o[0]instanceof unitUtils.p))throw new Error("Illegal Argument");return M$4.planarLength(o[0],a$2(O$5(o[1],-1)))}))},n.length3d=function(n,e){return I(n,e,(function(e,r,o){if(z$5(o,1,2),null===(o=me$2(o))[0])return 0;if(I$7(o[0])||J$3(o[0])){const e=he$2(o[0],n.spatialReference);return null===e?0:!0===e.hasZ?v$4(e,a$2(O$5(o[1],-1))):M$4.planarLength(e,a$2(O$5(o[1],-1)))}if(!(o[0]instanceof unitUtils.p))throw new Error("Illegal Argument");return !0===o[0].hasZ?v$4(o[0],a$2(O$5(o[1],-1))):M$4.planarLength(o[0],a$2(O$5(o[1],-1)))}))},n.lengthgeodetic=function(n,e){return I(n,e,(function(e,r,o){if(z$5(o,1,2),null===(o=me$2(o))[0])return 0;if(I$7(o[0])||J$3(o[0])){const e=he$2(o[0],n.spatialReference);return null===e?0:M$4.geodesicLength(e,a$2(O$5(o[1],-1)))}if(!(o[0]instanceof unitUtils.p))throw new Error("Illegal Argument");return M$4.geodesicLength(o[0],a$2(O$5(o[1],-1)))}))},n.distance=function(n,e){return I(n,e,(function(e,r,o){o=me$2(o),z$5(o,2,3);let u=o[0];(I$7(o[0])||J$3(o[0]))&&(u=pe$2(o[0],n.spatialReference));let s=o[1];if((I$7(o[1])||J$3(o[1]))&&(s=pe$2(o[1],n.spatialReference)),!(u instanceof unitUtils.p))throw new Error("Illegal Argument");if(!(s instanceof unitUtils.p))throw new Error("Illegal Argument");return M$4.distance(u,s,a$2(O$5(o[2],-1)))}))},n.distancegeodetic=function(n,e){return I(n,e,(function(n,e,r){r=me$2(r),z$5(r,2,3);const o=r[0],u=r[1];if(!(o instanceof unitUtils.b))throw new Error("Illegal Argument");if(!(u instanceof unitUtils.b))throw new Error("Illegal Argument");const f=new unitUtils.m$4({paths:[],spatialReference:o.spatialReference});return f.addPath([o,u]),M$4.geodesicLength(f,a$2(O$5(r[2],-1)))}))},n.densify=function(n,e){return I(n,e,(function(n,e,r){if(r=me$2(r),z$5(r,2,3),null===r[0])return null;if(!(r[0]instanceof unitUtils.p))throw new Error("Illegal Argument");const o=ee$2(r[1]);if(isNaN(o))throw new Error("Illegal Argument");if(o<=0)throw new Error("Illegal Argument");return r[0]instanceof unitUtils.v||r[0]instanceof unitUtils.m$4?M$4.densify(r[0],o,a$2(O$5(r[2],-1))):r[0]instanceof unitUtils.M?M$4.densify(P$4(r[0]),o,a$2(O$5(r[2],-1))):r[0]}))},n.densifygeodetic=function(n,e){return I(n,e,(function(n,e,r){if(r=me$2(r),z$5(r,2,3),null===r[0])return null;if(!(r[0]instanceof unitUtils.p))throw new Error("Illegal Argument");const o=ee$2(r[1]);if(isNaN(o))throw new Error("Illegal Argument");if(o<=0)throw new Error("Illegal Argument");return r[0]instanceof unitUtils.v||r[0]instanceof unitUtils.m$4?M$4.geodesicDensify(r[0],o,a$2(O$5(r[2],-1))):r[0]instanceof unitUtils.M?M$4.geodesicDensify(P$4(r[0]),o,a$2(O$5(r[2],-1))):r[0]}))},n.generalize=function(n,e){return I(n,e,(function(n,e,r){if(r=me$2(r),z$5(r,2,4),null===r[0])return null;if(!(r[0]instanceof unitUtils.p))throw new Error("Illegal Argument");const o=ee$2(r[1]);if(isNaN(o))throw new Error("Illegal Argument");return M$4.generalize(r[0],o,ie$3(O$5(r[2],!0)),a$2(O$5(r[3],-1)))}))},n.buffer=function(n,r){return I(n,r,(function(n,r,o){if(o=me$2(o),z$5(o,2,3),null===o[0])return null;if(!(o[0]instanceof unitUtils.p))throw new Error("Illegal Argument");const u=ee$2(o[1]);if(isNaN(u))throw new Error("Illegal Argument");return 0===u?c$2(o[0]):M$4.buffer(o[0],u,a$2(O$5(o[2],-1)))}))},n.buffergeodetic=function(n,r){return I(n,r,(function(n,r,o){if(o=me$2(o),z$5(o,2,3),null===o[0])return null;if(!(o[0]instanceof unitUtils.p))throw new Error("Illegal Argument");const u=ee$2(o[1]);if(isNaN(u))throw new Error("Illegal Argument");return 0===u?c$2(o[0]):M$4.geodesicBuffer(o[0],u,a$2(O$5(o[2],-1)))}))},n.offset=function(n,e){return I(n,e,(function(n,e,r){if(r=me$2(r),z$5(r,2,6),null===r[0])return null;if(!(r[0]instanceof unitUtils.v||r[0]instanceof unitUtils.m$4))throw new Error("Illegal Argument");const o=ee$2(r[1]);if(isNaN(o))throw new Error("Illegal Argument");const f=ee$2(O$5(r[4],10));if(isNaN(f))throw new Error("Illegal Argument");const a=ee$2(O$5(r[5],0));if(isNaN(a))throw new Error("Illegal Argument");return M$4.offset(r[0],o,a$2(O$5(r[2],-1)),$$4(O$5(r[3],"round")).toLowerCase(),f,a)}))},n.rotate=function(n,e){return I(n,e,(function(n,e,r){r=me$2(r),z$5(r,2,3);let t=r[0];if(null===t)return null;if(!(t instanceof unitUtils.p))throw new Error("Illegal Argument");t instanceof unitUtils.M&&(t=unitUtils.v.fromExtent(t));const o=ee$2(r[1]);if(isNaN(o))throw new Error("Illegal Argument");const u=O$5(r[2],null);if(null===u)return M$4.rotate(t,o);if(u instanceof unitUtils.b)return M$4.rotate(t,o,u);throw new Error("Illegal Argument")}))},n.centroid=function(n,r){return I(n,r,(function(r,t,o){if(o=me$2(o),z$5(o,1,1),null===o[0])return null;let u=o[0];if((I$7(o[0])||J$3(o[0]))&&(u=pe$2(o[0],n.spatialReference)),null===u)return null;if(!(u instanceof unitUtils.p))throw new Error("Illegal Argument");return u instanceof unitUtils.b?ae$3(c$2(o[0]),n.spatialReference):u instanceof unitUtils.v?u.centroid:u instanceof unitUtils.m$4?l$4(u):u instanceof unitUtils.m$5?u$3(u):u instanceof unitUtils.M?u.center:null}))},n.multiparttosinglepart=function(n,r){return I(n,r,(function(r,t,o){o=me$2(o),z$5(o,1,1);const u=[];if(null===o[0])return null;if(!(o[0]instanceof unitUtils.p))throw new Error("Illegal Argument");if(o[0]instanceof unitUtils.b)return [ae$3(c$2(o[0]),n.spatialReference)];if(o[0]instanceof unitUtils.M)return [ae$3(c$2(o[0]),n.spatialReference)];const f=M$4.simplify(o[0]);if(f instanceof unitUtils.v){const n=[],e=[];for(let r=0;r<f.rings.length;r++)if(f.isClockwise(f.rings[r])){const e=unitUtils.d$1({rings:[f.rings[r]],hasZ:!0===f.hasZ,hasM:!0===f.hasM,spatialReference:f.spatialReference.toJSON()});n.push(e);}else e.push({ring:f.rings[r],pt:f.getPoint(r,0)});for(let r=0;r<e.length;r++)for(let t=0;t<n.length;t++)if(n[t].contains(e[r].pt)){n[t].addRing(e[r].ring);break}return n}if(f instanceof unitUtils.m$4){const n=[];for(let e=0;e<f.paths.length;e++){const r=unitUtils.d$1({paths:[f.paths[e]],hasZ:!0===f.hasZ,hasM:!0===f.hasM,spatialReference:f.spatialReference.toJSON()});n.push(r);}return n}if(o[0]instanceof unitUtils.m$5){const r=ae$3(c$2(o[0]),n.spatialReference);for(let n=0;n<r.points.length;n++)u.push(r.getPoint(n));return u}return null}))},n.issimple=function(n,e){return I(n,e,(function(n,e,r){if(r=me$2(r),z$5(r,1,1),null===r[0])return !0;if(!(r[0]instanceof unitUtils.p))throw new Error("Illegal Argument");return M$4.isSimple(r[0])}))},n.simplify=function(n,e){return I(n,e,(function(n,e,r){if(r=me$2(r),z$5(r,1,1),null===r[0])return null;if(!(r[0]instanceof unitUtils.p))throw new Error("Illegal Argument");return M$4.simplify(r[0])}))};}
