...
const query = require('./query-0e394548.js');
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
async function m(m,s,n){const p$1=utils.e(m),a=await p(p$1,TopFeaturesQuery.S.from(s),{...n});return {count:a.data.count,extent:request.M.fromJSON(a.data.extent)}}
