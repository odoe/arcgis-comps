...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
class n$1{constructor(r){this.streamDataRequester=r;}async loadJSON(r,e){return this.load("json",r,e)}async loadBinary(r,e){return request.G(r)?(request.h(e),request.H(r)):this.load("binary",r,e)}async loadImage(r,e){return this.load("image",r,e)}async load(t,i,m){if(request.t(this.streamDataRequester))return (await request.E(i,{responseType:c$2[t]})).data;const n=await asyncUtils.a(this.streamDataRequester.request(i,t,m));if(!0===n.ok)return n.value;throw request.b$1(n.error),new request.s$1("",`Request for resource failed: ${n.error}`)}}const c$2={image:"image",binary:"array-buffer",json:"json"};

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
const o$3=request.s$2.getLogger("esri.views.3d.glTF");class t$3{error(e){throw new request.s$1("gltf-loader-error",e)}errorUnsupported(e){throw new request.s$1("gltf-loader-unsupported-feature",e)}errorUnsupportedIf(r,e){r&&this.errorUnsupported(e);}assert(r,e){r||this.error(e);}warn(r){o$3.warn(r);}warnUnsupported(r){this.warn("[Unsupported Feature] "+r);}warnUnsupportedIf(r,e){r&&this.warnUnsupported(e);}}
