...
const findLabelForComponent = (componentEl) => {
  ...
  return ((id && dom.queryElementRoots(componentEl, `${labelTagName}[for="${id}"]`)) ||
    dom.closestElementCrossShadowBoundary(componentEl, labelTagName));
};
/**
...
let CalciteSwitch$1 = class extends HTMLElement {
  constructor() {
    ...
    this.calciteSwitchChange = request.createEvent(this, "calciteSwitchChange", 7);
    //--------------------------------------------------------------------------
    //
    //  Properties
    //
  ...
  render() {
    ...
    return (request.h$4(request.Host, { "aria-checked": this.checked.toString(), "aria-label": getLabelText(this), onClick: this.clickHandler, role: "switch", tabindex: this.tabindex }, request.h$4("div", { class: { container: true, [dom.CSS_UTILITY.rtl]: dir === "rtl" } }, request.h$4("div", { class: "track" }, request.h$4("div", { class: "handle" })))));
  }
  get el() { return this; }
...
CalciteSwitch$1 = /*@__PURE__*/ request.proxyCustomElement(CalciteSwitch$1, [1, "calcite-switch", {
    "disabled": [516],
    "label": [1],
    "name": [513],
    "scale": [513],
...
exports.CalciteSwitch = CalciteSwitch;
