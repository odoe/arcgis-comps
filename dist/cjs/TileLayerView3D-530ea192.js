...
*/
let c=class extends(RefreshableLayerView.i(arcgisWebscene_entry.p(TileLayerView.i(LayerView3D.p(LayerView.u))))){constructor(){super(...arguments),this.type="tile-3d";}get imageFormatIsOpaque(){return "jpg"===this.layer.tileInfo.format}get hasMixedImageFormats(){return "mixed"===this.layer.tileInfo.format}get dataLevelRange(){if(this.tileInfo){const e=this.tileInfo.lods,r=e[0].scale,t=e[e.length-1].scale;return this.levelRangeFromScaleRange(r,t)}return {minLevel:0,maxLevel:0}}initialize(){if("web-tile"===this.layer.type){const e=this.layer.get("fullExtent.spatialReference"),i=this.layer.get("tileInfo.spatialReference");if(request.t$1(e)||request.t$1(i)||!projection.tn(e,i)){const e="defaults"===this.layer.originOf("fullExtent")||request.t$1(this.layer.fullExtent)?"SceneView requires fullExtent to be specified by the user on WebTileLayer":"SceneView requires fullExtent to be specified in the same spatial reference as tileInfo on WebTileLayer";this.addResolvingPromise(Promise.reject(new request.s("layerview:incompatible-fullextent",e)));}}this._addTilingSchemeMatchPromise();}createFetchPopupFeaturesQueryGeometry(e,r){return drapedUtils.a(e,r,this.view)}async doRefresh(e){this.suspended||this.emit("data-changed");}};request.e([request.d({readOnly:!0})],c.prototype,"imageFormatIsOpaque",null),request.e([request.d({readOnly:!0})],c.prototype,"hasMixedImageFormats",null),request.e([request.d({aliasOf:"layer.fullExtent"})],c.prototype,"fullExtent",void 0),request.e([request.d()],c.prototype,"layer",void 0),request.e([request.d({aliasOf:"layer.tileInfo"})],c.prototype,"tileInfo",void 0),request.e([request.d({readOnly:!0})],c.prototype,"dataLevelRange",null),c=request.e([request.i("esri.views.3d.layers.TileLayerView3D")],c);const y=c;
