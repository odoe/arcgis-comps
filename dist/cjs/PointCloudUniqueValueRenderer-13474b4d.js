...
*/
var s;let i$2=s=class extends JSONSupport.a{constructor(){super(...arguments),this.field=null,this.minValue=0,this.maxValue=255;}clone(){return new s({field:this.field,minValue:this.minValue,maxValue:this.maxValue})}};request.e([request.d({type:String,json:{write:!0}})],i$2.prototype,"field",void 0),request.e([request.d({type:Number,nonNullable:!0,json:{write:!0}})],i$2.prototype,"minValue",void 0),request.e([request.d({type:Number,nonNullable:!0,json:{write:!0}})],i$2.prototype,"maxValue",void 0),i$2=s=request.e([request.i("esri.renderers.support.pointCloud.ColorModulation")],i$2);const p$4=i$2;

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
const p$3=new request.o$1({pointCloudFixedSizeAlgorithm:"fixed-size",pointCloudSplatAlgorithm:"splat"});let i$1=class extends JSONSupport.a{};request.e([request.d({type:p$3.apiValues,readOnly:!0,nonNullable:!0,json:{type:p$3.jsonValues,read:!1,write:p$3.write}})],i$1.prototype,"type",void 0),i$1=request.e([request.i("esri.renderers.support.pointCloud.PointSizeAlgorithm")],i$1);const a$6=i$1;

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
var i;let p$2=i=class extends a$6{constructor(){super(...arguments),this.type="fixed-size",this.size=0,this.useRealWorldSymbolSizes=null;}clone(){return new i({size:this.size,useRealWorldSymbolSizes:this.useRealWorldSymbolSizes})}};request.e([unitUtils.r$2({pointCloudFixedSizeAlgorithm:"fixed-size"})],p$2.prototype,"type",void 0),request.e([request.d({type:Number,nonNullable:!0,json:{write:!0}})],p$2.prototype,"size",void 0),request.e([request.d({type:Boolean,json:{write:!0}})],p$2.prototype,"useRealWorldSymbolSizes",void 0),p$2=i=request.e([request.i("esri.renderers.support.pointCloud.PointSizeFixedSizeAlgorithm")],p$2);const l$4=p$2;

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
var p$1;let c$3=p$1=class extends a$6{constructor(){super(...arguments),this.type="splat",this.scaleFactor=1;}clone(){return new p$1({scaleFactor:this.scaleFactor})}};request.e([unitUtils.r$2({pointCloudSplatAlgorithm:"splat"})],c$3.prototype,"type",void 0),request.e([request.d({type:Number,value:1,nonNullable:!0,json:{write:!0}})],c$3.prototype,"scaleFactor",void 0),c$3=p$1=request.e([request.i("esri.renderers.support.pointCloud.PointSizeSplatAlgorithm")],c$3);const a$5=c$3;
