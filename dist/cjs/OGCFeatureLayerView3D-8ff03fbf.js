...
const OGCFeatureLayerView = require('./OGCFeatureLayerView-e1bb2813.js');
...
*/
let a=class extends(OGCFeatureLayerView.a(FeatureLayerViewBase3D.x)){constructor(){super(...arguments),this.type="ogc-feature-3d";}};request.e([request.d()],a.prototype,"layer",void 0),a=request.e([request.i("esri.views.3d.layers.OGCFeatureLayerView3D")],a);const p=a;
