...
const Container = require('./Container-2db43b58.js');

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
let e$1=class extends request.a$1{};e$1=request.e([request.i("esri.views.layers.support.ClipArea")],e$1);const t=e$1;
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
var y;const n={base:request.p$12,key:"type",typeMap:{extent:request.M,polygon:request.v$1}};let c$1=y=class extends t{constructor(){super(...arguments),this.type="geometry",this.geometry=null;}get version(){return (this._get("version")||0)+1}clone(){return new y({geometry:this.geometry.clone()})}};request.e([request.d({types:n,json:{read:request.d$7,write:!0}})],c$1.prototype,"geometry",void 0),request.e([request.d({readOnly:!0})],c$1.prototype,"version",null),c$1=y=request.e([request.i("esri.views.layers.support.Geometry")],c$1);const a=c$1;
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
const c=request.S$2.ofType({key:"type",base:t,typeMap:{rect:p$1,path:p,geometry:a}}),l=e=>{let p=class extends e{constructor(){super(...arguments),this.clips=new c,this.moving=!1,this.attached=!1,this.lastUpdateId=-1,this.updateRequested=!1;}initialize(){var t;this.container||(this.container=new Container.n),this.container.fadeTransitionEnabled=!0,this.container.opacity=0,this.container.clips=this.clips,this.handles.add([request.i$3(this,"suspended",(t=>{this.container&&(this.container.visible=!t),this.view&&!t&&this.updateRequested&&this.view.requestUpdate();}),!0),request.i$3(this,["layer.opacity","container"],(()=>{var t,e;this.container&&(this.container.opacity=null!=(t=null==(e=this.layer)?void 0:e.opacity)?t:1);}),!0),request.i$3(this,["layer.blendMode"],(t=>{this.container&&(this.container.blendMode=t);}),!0),request.i$3(this,["layer.effect"],(t=>{this.container&&(this.container.effect=t);}),!0),this.clips.on("change",(()=>{this.container.clips=this.clips,this.notifyChange("clips");}))]),null!=(t=this.view)&&t.whenLayerView?this.view.whenLayerView(this.layer).then((t=>{t!==this||this.attached||this.destroyed||(this.attach(),this.requestUpdate(),this.attached=!0);}),(()=>{})):this.when().then((()=>{this.attached||this.destroyed||(this.attach(),this.requestUpdate(),this.attached=!0);}),(()=>{}));}destroy(){this.attached&&(this.detach(),this.attached=!1),this.handles.remove("initialize"),this.updateRequested=!1;}get updating(){return !this.attached||!this.suspended&&(this.updateRequested||this.isUpdating())}isVisibleAtScale(t){let e=!0;const s=this.layer,i=s.minScale,r=s.maxScale;if(null!=i&&null!=r){let s=!i,a=!r;!s&&t<=i&&(s=!0),!a&&t>=r&&(a=!0),e=s&&a;}return e}requestUpdate(){this.destroyed||this.updateRequested||(this.updateRequested=!0,this.suspended||this.view.requestUpdate());}processUpdate(t){!this.isFulfilled()||this.isResolved()?(this._set("updateParameters",t),this.updateRequested&&!this.suspended&&(this.updateRequested=!1,this.update(t))):this.updateRequested=!1;}isUpdating(){return !1}isRendering(){return !1}canResume(){return !!super.canResume()&&this.isVisibleAtScale(this.view.scale)}};return request.e([request.d({type:c,set(t){const e=request.n$19(t,this._get("clips"),c);this._set("clips",e);}})],p.prototype,"clips",void 0),request.e([request.d()],p.prototype,"moving",void 0),request.e([request.d()],p.prototype,"attached",void 0),request.e([request.d()],p.prototype,"container",void 0),request.e([request.d()],p.prototype,"suspended",void 0),request.e([request.d({readOnly:!0})],p.prototype,"updateParameters",void 0),request.e([request.d()],p.prototype,"updateRequested",void 0),request.e([request.d()],p.prototype,"updating",null),request.e([request.d()],p.prototype,"view",void 0),p=request.e([request.i("esri.views.2d.layers.LayerView2D")],p),p};

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
let d=class extends(request.a$6(request.r$1(request.n$4(request.n$2.EventedMixin(request.p))))){constructor(e){super(e),this.layer=null,this.parent=null;}initialize(){this.when().catch((e=>{if("layerview:create-error"!==e.name){const t=this.layer&&this.layer.id||"no id",r=this.layer&&this.layer.title||"no title";throw request.s.getLogger(this.declaredClass).error("#resolve()",`Failed to resolve layer view (layer title: '${r}', id: '${t}')`,e),e}}));}get fullOpacity(){return request.c$10(this.get("layer.opacity"),1)*request.c$10(this.get("parent.fullOpacity"),1)}get suspended(){return !this.canResume()}get suspendInfo(){return this.getSuspendInfo()}get legendEnabled(){return !this.suspended&&!0===this.layer.legendEnabled}get updating(){return !!(this.updatingHandles&&this.updatingHandles.updating||this.isUpdating())}get updatingProgress(){return this.updating?0:1}get visible(){var e;return !0===(null==(e=this.layer)?void 0:e.visible)}set visible(e){void 0!==e?this._override("visible",e):this._clearOverride("visible");}canResume(){return !this.get("parent.suspended")&&this.get("view.ready")&&this.get("layer.loaded")&&this.visible||!1}getSuspendInfo(){const e=this.parent&&this.parent.suspended?this.parent.suspendInfo:{},t=this;return t.view&&t.view.ready||(e.viewNotReady=!0),this.layer&&this.layer.loaded||(e.layerNotLoaded=!0),this.visible||(e.layerInvisible=!0),e}isUpdating(){return !1}};request.e([request.d()],d.prototype,"fullOpacity",null),request.e([request.d()],d.prototype,"layer",void 0),request.e([request.d()],d.prototype,"parent",void 0),request.e([request.d({readOnly:!0})],d.prototype,"suspended",null),request.e([request.d({readOnly:!0})],d.prototype,"suspendInfo",null),request.e([request.d({readOnly:!0})],d.prototype,"legendEnabled",null),request.e([request.d({type:Boolean,readOnly:!0})],d.prototype,"updating",null),request.e([request.d({readOnly:!0})],d.prototype,"updatingProgress",null),request.e([request.d()],d.prototype,"visible",null),d=request.e([request.i("esri.views.layers.LayerView")],d);const u=d;
