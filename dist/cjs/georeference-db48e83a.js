...
*/
function a(n=U$2){return [n[0],n[1],n[2],n[3]]}function k$2(n,r,t=a()){return request.r$1(l(t),n),t[3]=r,t}function q$1(r,c,s=a()){return quat.I(b$2,l(r),x$2(r)),quat.I(d,l(c),x$2(c)),quat.v(b$2,d,b$2),y(s,request.m$17(quat.P(l(s),b$2)))}function l(n){return n}function x$2(n){return request.M(n[3])}function y(n,r){return n[3]=r,n}const U$2=[0,0,1,0],b$2=quatf64.e(),d=quatf64.e();

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
var B$2;let L$2=B$2=class extends request.a$5{constructor(r){super(r),this.origin=request.n(),this.translation=request.n(),this.rotation=a(),this.scale=request.r$11(1,1,1),this.geographic=!0;}get localMatrix(){const r=mat4f64.e();return request.i$21(r,r,this.scale),request.f$12(r,r,x$2(this.rotation),l(this.rotation)),request.c$16(r,r,this.translation),r}get localMatrixInverse(){return request.h$8(mat4f64.e(),this.localMatrix)}applyLocal(r,o){return request.I$3(o,r,this.localMatrix)}applyLocalInverse(r,o){return request.I$3(o,r,this.localMatrixInverse)}project(r,o){const t=new Float64Array(r.length),s=BufferView.T.fromTypedArray(t),e=BufferView.T.fromTypedArray(r);if(this.geographic){const r=request.A$4(request.p$9(o)),i=mat4f64.e();return request.vn(o,this.origin,i,r),request.e$27(i,i,this.localMatrix),vec33.e(s,e,i),request.xn(t,r,0,t,o,0,t.length/3),t}const{localMatrix:i,origin:a}=this;request.C$6(i,mat4f64.a)?vec33.e$1(s,e):vec33.e(s,e,i);for(let n=0;n<t.length;n+=3)t[n+0]+=a[0],t[n+1]+=a[1],t[n+2]+=a[2];return t}getOriginPoint(r){const[o,t,s]=this.origin;return new request.b$5({x:o,y:t,z:s,spatialReference:r})}equals(r){return request.r(r)&&this.geographic===r.geographic&&request.F$1(this.origin,r.origin)&&request.B$3(this.localMatrix,r.localMatrix)}clone(){const r={origin:request.t$13(this.origin),translation:request.t$13(this.translation),rotation:a(this.rotation),scale:request.t$13(this.scale),geographic:this.geographic};return new B$2(r)}};request.e([request.d({type:[Number],nonNullable:!0,json:{write:!0}})],L$2.prototype,"origin",void 0),request.e([request.d({type:[Number],nonNullable:!0,json:{write:!0}})],L$2.prototype,"translation",void 0),request.e([request.d({type:[Number],nonNullable:!0,json:{write:!0}})],L$2.prototype,"rotation",void 0),request.e([request.d({type:[Number],nonNullable:!0,json:{write:!0}})],L$2.prototype,"scale",void 0),request.e([request.d({type:Boolean,nonNullable:!0,json:{write:!0}})],L$2.prototype,"geographic",void 0),request.e([request.d()],L$2.prototype,"localMatrix",null),request.e([request.d()],L$2.prototype,"localMatrixInverse",null),L$2=B$2=request.e([request.i("esri.geometry.support.MeshTransform")],L$2);const O$1=L$2;
