...
*/
let i=class extends(MapImageLayerView.c(DynamicLayerView3D.V)){constructor(){super(...arguments),this.type="map-image-3d";}initialize(){this.updatingHandles.add(this,"exportImageVersion",(()=>this.updatingHandles.addPromise(this.refreshDebounced())));}createFetchPopupFeaturesQueryGeometry(e,r){return drapedUtils.a(e,r,this.view)}getFetchOptions(){return {timeExtent:this.timeExtent}}};i=request.e([request.i("esri.views.3d.layers.MapImageLayerView3D")],i);const a=i;
