...
*/
let e$1=class extends request.a$5{};e$1=request.e([request.i("esri.views.layers.support.ClipArea")],e$1);const t=e$1;
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
var y;const n={base:request.p$7,key:"type",typeMap:{extent:request.M$1,polygon:request.v$2}};let c$1=y=class extends t{constructor(){super(...arguments),this.type="geometry",this.geometry=null;}get version(){return (this._get("version")||0)+1}clone(){return new y({geometry:this.geometry.clone()})}};request.e([request.d({types:n,json:{read:request.d$9,write:!0}})],c$1.prototype,"geometry",void 0),request.e([request.d({readOnly:!0})],c$1.prototype,"version",null),c$1=y=request.e([request.i("esri.views.layers.support.Geometry")],c$1);const a=c$1;
