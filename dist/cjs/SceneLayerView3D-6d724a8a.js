...
*/
const Q=request.s$1.getLogger("esri.views.3d.layers.SceneLayerView3D"),q=SceneLayerView.i$1();let D=class extends(I3SMeshView3D.$e(DefinitionExpressionSceneLayerView.p(PopupSceneLayerView.c(LayerView3D.p(SceneLayerView.o))))){constructor(){super(...arguments),this.type="scene-layer-3d",this.lodFactor=1,this.progressiveLoadFactor=1,this._elevationContext="scene",this._isIntegratedMesh=!1,this._supportsLabeling=!0,this._interactiveEditingSessions=new Map,this._queryEngine=null;}get filter(){return request.r(this.viewFilter)?this.viewFilter.filter:null}set filter(e){!request.t$1(e)&&I3SQueryFeatureStore.O.checkSupport(e)?request.r(this.viewFilter)?this.viewFilter.filter=e:this.viewFilter=new I3SQueryFeatureStore.O({filter:e,layerFieldsIndex:this.layer.fieldsIndex,loadAsyncModule:e=>this._loadAsyncModule(e),applyFilters:()=>this._applyFilters(!0),addSqlFilter:(e,t)=>this.addSqlFilter(e,t,this.logError)}):this.viewFilter=null;}get requiredFields(){var e,t;return null!=(e=null==(t=this.fieldsHelper)?void 0:t.requiredFields)?e:[]}get floorFilterClause(){const e=floorFilterUtils.o(this);return request.r(e)?WhereClause.WhereClause.create(e,this.layer.fieldsIndex):null}get lodCrossfadeinDuration(){var e,t;return null!=(e=null==(t=this.view)?void 0:t.qualitySettings.sceneService["3dObject"].lodCrossfadeinDuration)?e:0}get lodCrossfadeoutDuration(){var e,t;return null!=(e=null==(t=this.view)?void 0:t.qualitySettings.sceneService["3dObject"].lodCrossfadeoutDuration)?e:0}get lodCrossfadeUncoveredDuration(){var e,t;return null!=(e=null==(t=this.view)?void 0:t.qualitySettings.sceneService["3dObject"].lodCrossfadeUncoveredDuration)?e:0}initialize(){this.fieldsHelper=new SceneLayerView.c({layerView:this}),this.updatingHandles.add(this.layer,"rangeInfos",(e=>this._rangeInfosChanged(e)),2),this.updatingHandles.add(this.layer,"renderer",(e=>this.updatingHandles.addPromise(this._rendererChange(e))),2);for(const e of ["parsedDefinitionExpression","filter","viewFilter.parsedWhereClause","viewFilter.parsedGeometry","viewFilter.sortedObjectIds","floorFilterClause"])this.updatingHandles.add(this,e,(()=>this._filterChange()));for(const e of ["filter","viewFilter.parsedGeometry"])this.updatingHandles.add(this,e,(()=>this._geometryFilterChange()));this.handles.add(this.layer.on("apply-edits",(e=>this.updatingHandles.addPromise(e.result)))),this.handles.add(this.layer.on("edits",(e=>this._handleEdits(e))));}destroy(){this.fieldsHelper=request.l$3(this.fieldsHelper);}_rangeInfosChanged(e){null!=e&&e.length>0&&Q.warn("Unsupported property: rangeInfos are currently only serialized to and from web scenes but do not affect rendering.");}createQuery(){const e={outFields:["*"],returnGeometry:!1,outSpatialReference:this.view.spatialReference};return request.r(this.filter)?this.filter.createQuery(e):new Query.b(e)}queryExtent(e,t){return this._ensureQueryEngine().executeQueryForExtent(this._ensureQuery(e),null==t?void 0:t.signal)}queryFeatureCount(e,t){return this._ensureQueryEngine().executeQueryForCount(this._ensureQuery(e),null==t?void 0:t.signal)}queryFeatures(e,t){return this._ensureQueryEngine().executeQuery(this._ensureQuery(e),null==t?void 0:t.signal).then((e=>{if(null==e||!e.features)return e;const t=this.layer;for(const r of e.features)r.layer=t,r.sourceLayer=t;return e}))}queryObjectIds(e,t){return this._ensureQueryEngine().executeQueryForIds(this._ensureQuery(e),null==t?void 0:t.signal)}_ensureQueryEngine(){return this._queryEngine||(this._queryEngine=this._createQueryEngine()),this._queryEngine}_createQueryEngine(){const e=I3SMeshView3D.u(this.view.spatialReference,this.view.renderSpatialReference,this._collection);return new I3SQueryFeatureStore.d({layerView:this,priority:Scheduler.f.FEATURE_QUERY_ENGINE,spatialIndex:new I3SQueryFeatureStore.d$1({featureAdapter:new I3SQueryFeatureStore.n({objectIdField:this.layer.objectIdField,attributeStorageInfo:this.layer.attributeStorageInfo,getFeatureExtent:e}),forAllFeatures:(e,t)=>this._forAllFeatures(((t,r,i)=>e({id:t,index:r,meta:i})),t,2),getFeatureExtent:e,sourceSpatialReference:I3SUtil.de(this.layer),viewSpatialReference:this.view.spatialReference})})}highlight(e){const t=this._highlights;if(e instanceof Query.b){const{set:r,handle:i}=t.acquireSet();return this.queryObjectIds(e).then((e=>t.setFeatureIds(r,e))),i}return super.highlight(e)}createInteractiveEditSession(e){return SceneLayerView.s(this.attributeEditingContext,e)}_createLayerGraphic(e){const r=new Graphic.h(null,null,e);return r.layer=this.layer,r.sourceLayer=this.layer,r}canResume(){return super.canResume()&&(!this._controller||this._controller.rootNodeVisible)}getFilters(){const e=super.getFilters();return this.floorFilterClause&&this.addSqlFilter(e,this.floorFilterClause,this.logError),this.addSqlFilter(e,this.parsedDefinitionExpression,this.logError),request.r(this.viewFilter)&&this.viewFilter.addFilters(e,this.view,this._controller.crsIndex,this._collection),e}_ensureQuery(e){return this._addDefinitionExpressionToQuery(request.t$1(e)?this.createQuery():Query.b.from(e))}get attributeEditingContext(){return {sessions:this._interactiveEditingSessions,fieldsIndex:this.layer.fieldsIndex,objectIdField:this._getObjectIdField(),forEachNode:e=>this._forAllNodes((t=>request.r(t)?e(t.node,t.featureIds):null)),attributeStorageInfo:this.i3slayer.attributeStorageInfo,attributeOverrides:this.attributeOverrides,getAttributeData:e=>this.getAttributeData(e),setAttributeData:(e,t)=>this.setAttributeData(e,t),clearMemCache:()=>this.clearMemCache()}}_handleEdits(e){SceneLayerView.i(this.attributeEditingContext,e);}get hasGeometryFilter(){const e=this.viewFilter;return request.r(e)&&request.r(e.parsedGeometry)}computeNodeFiltering(e){const t=this.viewFilter;return request.t$1(t)||t.isMBSGeoemtryVisible(e,this.view.spatialReference,this._controller.crsIndex)?0:1}};request.e([request.d({aliasOf:"layer"})],D.prototype,"i3slayer",void 0),request.e([request.d()],D.prototype,"suspended",void 0),request.e([request.d(arcgisWebscene_entry.t)],D.prototype,"updatingProgress",void 0),request.e([request.d({type:labelingInfo.y})],D.prototype,"filter",null),request.e([request.d()],D.prototype,"viewFilter",void 0),request.e([request.d(q.requiredFields)],D.prototype,"requiredFields",null),request.e([request.d(q.availableFields)],D.prototype,"availableFields",void 0),request.e([request.d()],D.prototype,"fieldsHelper",void 0),request.e([request.d()],D.prototype,"floorFilterClause",null),request.e([request.d({readOnly:!0,aliasOf:"view.qualitySettings.sceneService.3dObject.lodFactor"})],D.prototype,"lodFactor",void 0),request.e([request.d({readOnly:!0,aliasOf:"_controller.updatingProgress"})],D.prototype,"updatingProgressValue",void 0),D=request.e([request.i("esri.views.3d.layers.SceneLayerView3D")],D);const O=D;
