...
*/
const c=new request.o$1({classBreaksDef:"class-breaks-definition",uniqueValueDef:"unique-value-definition"});let l$1=class extends request.a$5{constructor(){super(...arguments),this.baseSymbol=null,this.colorRamp=null,this.type=null;}};request.e([request.d({type:request.a$17,json:{write:!0}})],l$1.prototype,"baseSymbol",void 0),request.e([request.d({types:request.m$15,json:{read:{reader:request.p$8},write:!0}})],l$1.prototype,"colorRamp",void 0),request.e([request.d({json:{read:c.read,write:c.write}})],l$1.prototype,"type",void 0),l$1=request.e([request.i("esri.rest.support.ClassificationDefinition")],l$1);const m=l$1;
