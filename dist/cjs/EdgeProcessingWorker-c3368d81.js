...
const deduplicate = require('./deduplicate-91c52f8d.js');
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
const p=-1;function u$1(n,i,l,g=V){const f=n.vertices.position,m=n.vertices.componentIndex,u=mathUtils.M(g.anglePlanar),I=mathUtils.M(g.angleSignificantEdge),N=Math.cos(I),j=Math.cos(u),x=y.edge,F=x.position0,E=x.position1,U=x.faceNormal0,k=x.faceNormal1,D=w(n),M=v(n),P=M.length/4,S=i.allocate(P);let b=0;const L=P,q=l.allocate(L);let z=0,B=0,C=0;const G=request.m$6(0,P),H=new Float32Array(P);request.n$16(H,((e,t,n)=>{f.getVec(M[4*t+0],F),f.getVec(M[4*t+1],E),n[t]=mathUtils.q(F,E);})),G.sort(((e,t)=>H[t]-H[e]));const J=new Array,K=new Array;for(let e=0;e<P;e++){const t=G[e],n=H[t],o=M[4*t+0],r=M[4*t+1],g=M[4*t+2],v=M[4*t+3],w=v===p;if(f.getVec(o,F),f.getVec(r,E),w)mathUtils.o(U,D[3*g+0],D[3*g+1],D[3*g+2]),mathUtils.r(k,U),x.componentIndex=m.get(o),x.cosAngle=mathUtils.z(U,k);else {if(mathUtils.o(U,D[3*g+0],D[3*g+1],D[3*g+2]),mathUtils.o(k,D[3*v+0],D[3*v+1],D[3*v+2]),x.componentIndex=m.get(o),x.cosAngle=mathUtils.z(U,k),d$1(x,j))continue;x.cosAngle<-.9999&&mathUtils.r(k,U);}B+=n,C++,w||h(x,N)?(i.write(S,b++,x),J.push(n)):A(x,u)&&(l.write(q,z++,x),K.push(n));}const O=new Float32Array(J.reverse()),Q=new Float32Array(K.reverse());return {regular:{instancesData:i.trim(S,b),lodInfo:{lengths:O}},silhouette:{instancesData:l.trim(q,z),lodInfo:{lengths:Q}},averageEdgeLength:B/C}}function h(e,t){return e.cosAngle<t}function d$1(e,t){return e.cosAngle>t}function A(e,t){const o=mathUtils.l(e.cosAngle),r=y.fwd,s=y.ortho;mathUtils.H(r,e.position1,e.position0);return o*(mathUtils.z(mathUtils._(s,e.faceNormal0,e.faceNormal1),r)>0?-1:1)>t}function v(e){const t=e.faces.length/3,n=e.faces,o=e.neighbors;let r=0;for(let a=0;a<t;a++){const e=o[3*a+0],t=o[3*a+1],s=o[3*a+2],c=n[3*a+0],i=n[3*a+1],l=n[3*a+2];r+=e===p||c<i?1:0,r+=t===p||i<l?1:0,r+=s===p||l<c?1:0;}const s=new Int32Array(4*r);let c=0;for(let a=0;a<t;a++){const e=o[3*a+0],t=o[3*a+1],r=o[3*a+2],i=n[3*a+0],l=n[3*a+1],g=n[3*a+2];(e===p||i<l)&&(s[c++]=i,s[c++]=l,s[c++]=a,s[c++]=e),(t===p||l<g)&&(s[c++]=l,s[c++]=g,s[c++]=a,s[c++]=t),(r===p||g<i)&&(s[c++]=g,s[c++]=i,s[c++]=a,s[c++]=r);}return s}function w(e){const t=e.faces.length/3,n=e.vertices.position,o=e.faces,r=I.v0,s=I.v1,c=I.v2,a=new Float32Array(3*t);for(let i=0;i<t;i++){const e=o[3*i+0],t=o[3*i+1],m=o[3*i+2];n.getVec(e,r),n.getVec(t,s),n.getVec(m,c),mathUtils.c(s,s,r),mathUtils.c(c,c,r),mathUtils._(r,s,c),mathUtils.j$1(r,r),a[3*i+0]=r[0],a[3*i+1]=r[1],a[3*i+2]=r[2];}return a}const y={edge:{position0:common.n(),position1:common.n(),faceNormal0:common.n(),faceNormal1:common.n(),componentIndex:0,cosAngle:0},ortho:common.n(),fwd:common.n()},I={v0:common.n(),v1:common.n(),v2:common.n()},V={anglePlanar:4,angleSignificantEdge:35};

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
async function a(e){const t=u(e),n=f(t),r=[t.data.buffer];return {result:c(n,r),transferList:r}}function f(e){const t=g(e.data,e.skipDeduplicate,e.indices,e.indicesLength);return d.updateSettings(e.writerSettings),l.updateSettings(e.writerSettings),u$1(t,d,l)}function u(e$1){return {data:e.createView(e$1.dataBuffer),indices:"Uint32Array"===e$1.indicesType?new Uint32Array(e$1.indicesBuffer):"Uint16Array"===e$1.indicesType?new Uint16Array(e$1.indicesBuffer):void 0,indicesLength:e$1.indicesLength,writerSettings:e$1.writerSettings,skipDeduplicate:e$1.skipDeduplicate}}function c(e,t){t.push(e.regular.lodInfo.lengths.buffer),t.push(e.silhouette.lodInfo.lengths.buffer);return {regular:{instancesData:z(e.regular.instancesData,t),lodInfo:{lengths:e.regular.lodInfo.lengths.buffer}},silhouette:{instancesData:z(e.silhouette.instancesData,t),lodInfo:{lengths:e.silhouette.lodInfo.lengths.buffer}},averageEdgeLength:e.averageEdgeLength}}function g(n,i,s,o){if(i){return {faces:s,facesLength:o,neighbors:t(s,o,n.count),vertices:n}}const a=deduplicate.n(n.buffer,n.stride/4,{originalIndices:s,originalIndicesLength:o}),f=t(a.indices,o,a.uniqueCount);return {faces:a.indices,facesLength:a.indices.length,neighbors:f,vertices:e.createView(a.buffer)}}const d=new d$2,l=new w$1;
...
exports.D = D;
exports.EdgeProcessingWorker = EdgeProcessingWorker;
exports.d = d$2;
exports.e = e;
exports.f = f;
exports.i = i;
