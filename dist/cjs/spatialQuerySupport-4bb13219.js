...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
const j$1=new request.o$1({esriSRUnit_Meter:"meters",esriSRUnit_Kilometer:"kilometers",esriSRUnit_Foot:"feet",esriSRUnit_StatuteMile:"miles",esriSRUnit_NauticalMile:"nautical-miles",esriSRUnit_USNauticalMile:"us-nautical-miles"}),U=Object.freeze({}),M=new request.t$10,F=new request.t$10,G$1=new request.t$10,N={esriGeometryPoint:request.G$3,esriGeometryPolyline:request.U$2,esriGeometryPolygon:request.C$5,esriGeometryMultipoint:request._};function O(e,r,i,o=e.hasZ,n=e.hasM){if(request.t(r))return null;const s=e.hasZ&&o,l=e.hasM&&n;if(i){const t=request.it(G$1,r,e.hasZ,e.hasM,"esriGeometryPoint",i,o,n);return request.G$3(t,s,l)}return request.G$3(r,s,l)}function J(e,i,o,n,s,l,a=i,m=o){const c=i&&a,f=o&&m,g=request.r(n)?"coords"in n?n:n.geometry:null;if(request.t(g))return null;if(s){let t=request.ft(F,g,i,o,e,s,a,m);return l&&(t=request.it(G$1,t,c,f,e,l)),N[e](t,c,f)}if(l){const t=request.it(G$1,g,i,o,e,l,a,m);return N[e](t,c,f)}return request.yt(M,g,i,o,a,m),N[e](M,c,f)}async function P$1(e,t,r){const{outFields:i,orderByFields:o,groupByFieldsForStatistics:n,outStatistics:s}=e;if(i)for(let l=0;l<i.length;l++)i[l]=i[l].trim();if(o)for(let l=0;l<o.length;l++)o[l]=o[l].trim();if(n)for(let l=0;l<n.length;l++)n[l]=n[l].trim();if(s)for(let l=0;l<s.length;l++)s[l].onStatisticField&&(s[l].onStatisticField=s[l].onStatisticField.trim());return e.geometry&&!e.outSR&&(e.outSR=e.geometry.spatialReference),Z(e,t,r)}async function Z(e,r,i){if(!e)return null;let{where:l}=e;if(e.where=l=l&&l.trim(),(!l||/^1 *= *1$/.test(l)||r&&r===l)&&(e.where=null),!e.geometry)return e;let a=await b(e);if(e.distance=0,e.units=null,"esriSpatialRelEnvelopeIntersects"===e.spatialRel){const{spatialReference:t}=e.geometry;a=request.l$16(a),a.spatialReference=t;}e.geometry=a,await projectionSupport.f(a.spatialReference,i);const m=(await request.v$4(request.d$9(a)))[0];if(request.t(m))throw U;const c=m.toJSON(),u=await projectionSupport.g(c,c.spatialReference,i);if(!u)throw U;return u.spatialReference=i,e.geometry=u,e}async function b(e){const{geometry:t,distance:r,units:o}=e;if(null==r||"vertexAttributes"in t)return t;const n=t.spatialReference,s=o?j$1.fromJSON(o):request.z$5(n),c=n&&(request.R$1(n)||request.T$2(n))?t:await projectionSupport.f(n,request.c$15).then((()=>projectionSupport.g(t,request.c$15)));return (await x())(c.spatialReference,c,r,s)}async function x(){return (await Promise.resolve().then(function () { return require('./geometryEngineJSON-9696d850.js'); })).geodesicBuffer}function z(e){return e&&B in e?JSON.parse(JSON.stringify(e,E)):e}const B="_geVersion",E=(e,t)=>e!==B?t:void 0;

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
function n$1(n){return "mesh"===n?request.o$14:request.G$4(n)}
...
See https://js.arcgis.com/4.22/esri/copyright.txt for details.
*/
const c="feature-store:unsupported-query",R={esriSpatialRelIntersects:"intersects",esriSpatialRelContains:"contains",esriSpatialRelCrosses:"crosses",esriSpatialRelDisjoint:"disjoint",esriSpatialRelEnvelopeIntersects:"intersects",esriSpatialRelIndexIntersects:null,esriSpatialRelOverlaps:"overlaps",esriSpatialRelTouches:"touches",esriSpatialRelWithin:"within",esriSpatialRelRelation:null},S={spatialRelationship:{esriSpatialRelIntersects:!0,esriSpatialRelContains:!0,esriSpatialRelWithin:!0,esriSpatialRelCrosses:!0,esriSpatialRelDisjoint:!0,esriSpatialRelTouches:!0,esriSpatialRelOverlaps:!0,esriSpatialRelEnvelopeIntersects:!0,esriSpatialRelIndexIntersects:!1,esriSpatialRelRelation:!1},queryGeometry:{esriGeometryPoint:!0,esriGeometryMultipoint:!0,esriGeometryPolyline:!0,esriGeometryPolygon:!0,esriGeometryEnvelope:!0},layerGeometry:{esriGeometryPoint:!0,esriGeometryMultipoint:!0,esriGeometryPolyline:!0,esriGeometryPolygon:!0,esriGeometryEnvelope:!1}};function G(e){return !0===S.spatialRelationship[e]}function g(e){return !0===S.queryGeometry[request.v$3(e)]}function j(e){return !0===S.layerGeometry[e]}function h(){return Promise.resolve().then(function () { return require('./geometryEngineJSON-9696d850.js'); })}function v(e,n,l,y,c){if(request.c$10(n)&&"esriGeometryPoint"===l&&("esriSpatialRelIntersects"===e||"esriSpatialRelContains"===e)){const e=request.D$1(new request.t$10,n,!1,!1);return Promise.resolve((r=>t(e,!1,!1,r)))}if(request.c$10(n)&&"esriGeometryMultipoint"===l){const r$1=request.D$1(new request.t$10,n,!1,!1);if("esriSpatialRelContains"===e)return Promise.resolve((e=>r(r$1,!1,!1,e,y,c)))}if(request.s$11(n)&&"esriGeometryPoint"===l&&("esriSpatialRelIntersects"===e||"esriSpatialRelContains"===e))return Promise.resolve((e=>request.r$15(n,J(l,y,c,e))));if(request.s$11(n)&&"esriGeometryMultipoint"===l&&"esriSpatialRelContains"===e)return Promise.resolve((e=>request.i$20(n,J(l,y,c,e))));if(request.s$11(n)&&"esriSpatialRelIntersects"===e){const e=n$1(l);return Promise.resolve((r=>e(n,J(l,y,c,r))))}return h().then((r=>{const t=r[R[e]].bind(null,n.spatialReference,n);return e=>t(J(l,y,c,e))}))}async function P(r,t,i){const{spatialRel:s,geometry:o}=r;if(o){if(!G(s))throw new request.s$1(c,"Unsupported query spatial relationship",{query:r});if(request.I$1(o.spatialReference)&&request.I$1(i)){if(!g(o))throw new request.s$1(c,"Unsupported query geometry type",{query:r});if(!j(t))throw new request.s$1(c,"Unsupported layer geometry type",{query:r});if(r.outSR)return projectionSupport.f(r.geometry&&r.geometry.spatialReference,r.outSR)}}}function I(e){if(request.s$11(e))return !0;if(request.c$10(e)){for(const r of e.rings){if(5!==r.length)return !1;if(r[0][0]!==r[1][0]||r[0][0]!==r[4][0]||r[2][0]!==r[3][0]||r[0][1]!==r[3][1]||r[0][1]!==r[4][1]||r[1][1]!==r[2][1])return !1}return !0}return !1}
