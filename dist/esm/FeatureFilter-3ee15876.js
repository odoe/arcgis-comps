import { c as s$1, s as s$2, A as r } from './messageBundle-f75b4090.js';
import { u } from './aaBoundingRect-9468599b.js';
import { g as c } from './geometry-7e07b1ba.js';
import { Z, v, n } from './spatialQuerySupport-8e60e1e7.js';
import { b } from './Query-d6335b3a.js';
import { u as u$1 } from './FeatureStore2D-5c6fc0bd.js';
...
*/
const t=s$1.getLogger("esri.views.2d.layers.features.support.whereUtils"),a={getAttribute:(e,r)=>e.field(r)};async function s(r,s){const n=await import('./WhereClause-a0e7b548.js');try{const o=n.WhereClause.create(r,s);if(!o.isStandardized){const r=new s$2("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",o);t.error(r);}return e=>{const r=e.readArcadeFeature();return o.testFeature(r,a)}}catch(o){return t.warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",r),e=>!0}}
